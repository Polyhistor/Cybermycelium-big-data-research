...
\subsection{Step 5: Enabling RA with Variability}
...
This section is constituent of three integral elements: software requirements, design theories and the artefact. First, we begin by exploring the requirements that underpin the development of the artefact. Second, the design theories that guide the creation of the artefact are discussed. Lastly the artefact is presented and its components are described.


\section{Software and System Requirements of Cybermycelium} \label{requirements-section}

By the result of the processes conducted hereinabove, and by carefully evaluating similar approaches to requirement specification, a set of requirement for the development for Cybermycelium is identified. These requirements are presented in terms of BD characteristics in the following sub-sections.
...
\begin{table}
    ...
    \begin{tabular}{|p{1.2cm}|p{0.8cm}|p{8.3cm}|} % Adjusted column widths
    \hline
    \textbf{Cat.} & \textbf{Code} & \textbf{Req.} \\
    \hline
    Vol. & 1 & Support async, streaming, and batch processing for data collection from various sources. \\\cline{2-3}
        & 2 & Provide scalable storage for massive data sets. \\\cline{2-3}
    Vel. & 1 & Support slow, bursty, and high throughput data transmission between sources. \\\cline{2-3}
        & 2 & Stream data to consumers in a timely manner. \\\cline{2-3}
        & 3 & Ingest multiple, continuous, time-varying data streams. \\\cline{2-3}
        & 4 & Support fast search from streaming and processed data with high accuracy and relevancy. \\\cline{2-3}
        & 5 & Process data in real-time or near real-time. \\\cline{2-3} 
    % Removed extra & and added \cline for all cells in this column to resolve the errors
    Var. & 1 & Support data in various formats: structured to semi-structured and unstructured. \\\cline{2-3}
        & 2 & Support aggregation, standardization, and normalization of data from disparate sources. \\\cline{2-3}
        & 3 & Support adaptation mechanisms for schema evolution. \\\cline{2-3}
        & 4 & Provide mechanisms to automatically include new data sources. \\\cline{2-3}
    Val. & 1 & Handle compute-intensive analytical processing and machine learning techniques. \\\cline{2-3}
        & 2 & Support batch and streaming analytical processing. \\\cline{2-3}
        & 3 & Support different output file formats for different purposes. \\\cline{2-3}
        & 4 & Support streaming results to consumers. \\\cline{2-3}
    SaP & 1 & Protect and retain privacy and security of sensitive data. \\\cline{2-3}
        & 2 & Have access control, multi-level, policy-driven authentication on protected data and nodes. \\\cline{2-3} 
    Ver. & 1 & Support data quality curation: classification, pre-processing, format reduction, and transformation. \\\cline{2-3}
        & 2 & Support data provenance: data life cycle mgmt. and long-term preservation. \\\hline 
    \end{tabular}
\end{table}
